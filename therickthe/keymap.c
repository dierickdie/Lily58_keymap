 ...
 */
 ...
 [_QW] = LAYOUT( \
    ...
    KC_TAB,     KC_A,       KC_S,       KC_D,       KC_F,       KC_G,                                       KC_H,       GUI_J,      KC_K,       KC_L,       KC_SCLN,    SFT_QUOT,  \
    KC_LCTRL,   KC_Q,       KC_W,       KC_E,       KC_R,       KC_T,                                       KC_Y,       KC_U,       KC_I,       KC_O,       KC_P,       KC_DEL,    \
    KC_LSFT,    KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,       KC_MUTE,             KC_MPLY,   KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    SFT_ENT,   \
                      xxxxxxx,    MO(7),    KC_LALT,   KC_SPC,        KC_ENT,                      RSE_SPC,        KC_SPC,       KC_RALT,    KC_RCTRL,    xxxxxxx                 \
),
 ...
 */
 ...
 [_LOWER] = LAYOUT( \
    _______,    _______,    _______,    _______,    _______,    KC_NO,                                      _______,    _______,     KC_EQL,    KC_PSLS,    KC_PAST,    KC_PMNS,   \
    ...
    _______,    KC_LEFT,    KC_DOWN,    KC_UP,      KC_RIGHT,   KC_NO,      _______,           _______,     _______,    KC_SPC,      KC_P1,     KC_P2,      KC_P3,      KC_PENT,   \
                      xxxxxxx,    _______,    _______,    _______,         _______,              _______,         LWL0_P0,       KC_P0,        KC_PDOT,    xxxxxxx                 \
  ),
   ...
   */
   ...
   [_LWL0] = LAYOUT( \
      ...
      _______,    _______,    _______,    _______,    _______,    _______,    _______,           _______,     _______,    _______,    KC_HOME,    KC_PGDN,    KC_PGUP,    KC_END,   \
                        xxxxxxx,    _______,    _______,    _______,         _______,              TG(1),             _______,    _______,    _______,    xxxxxxx                   \
    ),
...
[_RAISE] = LAYOUT( \
    TD(TILDE),  _______,    _______,    _______,    _______,    _______,                                    _______,    _______,    _______,    KC_MINS,    KC_EQUAL,   _______,   \
    _______,    _______,    _______,    _______,    _______,    _______,                                    _______,    _______,    KC_LBRC,    KC_LBRC,    TD(PIPE),   _______,   \
