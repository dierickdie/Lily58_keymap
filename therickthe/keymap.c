 ...
 * '-----------------------------------------------------------------------'/-----------/    \-----------\'-----------------------------------------------------------------------'
 *                             |   Ctrl    |    Alt    |   GUI    |        /    BS     /      \   Space   \        |   Down    |    Up     |   Right   |
 *                             '----------------------------------'       /-----------/        \-----------\       '-----------------------------------'
 */
 ...
 [_QWERTY] = LAYOUT( \
    ...
    KC_LSFT,    GUI_Z,      SFT_X,      KC_C,       KC_V,       KC_B,       KC_MPLY,           KC_MPLY,     KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    SFT_ENT,   \
                                 KC_LCTRL,    KC_LALT,   KC_LGUI,        LWR_BS,                 KC_SPC,             KC_RGUI,    KC_RALT,    KC_RCTRL    \
),
 ...
 * |           |     (     |     )     |     -     |     =     |    ***    |                              |    ***    |    BS     |     7     |     8     |     9     |     -     |
 * |-----------+-----------+-----------+-----------+-----------+-----------|                              |-----------+-----------+-----------+-----------+-----------+-----------|
 * |           |   Home    |   PgDn    |    PgUp   |    End    |    ***    |                              |    F4     |    F2     |     4     |     5     |     6     |     +     |
 * |-----------+-----------+-----------+-----------+-----------+-----------|                              |-----------+-----------+-----------+-----------+-----------+-----------|
 * |   LWL0    |   Left    |   Down    |    Up     |   Right   |    ***    |-----------.      .-----------|           | NotifCent |     1     |     2     |     3     |   Enter   |
 * |-----------+-----------+-----------+-----------+-----------+-----------|           |      |           |-----------+-----------+-----------+-----------+-----------+-----------|
 * |           |           |           |           |           |           |-----------'      '-----------|           |   LWL0    |     0     |     .     |     *     |     /     |
 * '-----------------------------------------------------------------------'/-----------/    \-----------\'-----------------------------------------------------------------------'
 *                             |           |           |          |        /   Lower   /      \           \        |           |           |           |
 ...
 */
 ...
 [_LOWER] = LAYOUT( \
    ...
    _______,    KC_HOME,    KC_PGDN,    KC_PGUP,    KC_END,     KC_NO,                                      KC_F4,      KC_F2,       KC_P4,     KC_P5,      KC_P6,      KC_PPLS,   \
    LWL0_TAB,   KC_LEFT,    KC_DOWN,    KC_UP,      LWL1_RGHT,  KC_NO,                                      _______,    NOTIFCENT,   KC_P1,     KC_P2,      KC_P3,      KC_PENT,   \
    _______,    _______,    _______,    _______,    _______,    _______,    _______,           _______,     _______,    LWL0_SPC,    KC_P0,     KC_PDOT,    KC_PAST,    KC_PSLS,   \
...
[_RAISE] = LAYOUT( \
    TD(TILDE),  _______,    _______,     _______,    _______,    _______,                                    _______,    _______,    _______,    KC_LBRC,    KC_LBRC,    KC_RBRC,   \
    _______,    _______,    _______,    _______,    _______,    _______,                                    _______,    _______,    _______,    _______,    _______,    _______,   \
    _______,    _______,    _______,    _______,    _______,    _______,                                    _______,    GUI_LEFT,   ALT_DN,     ALT_UP,     GUI_RGHT,   _______,   \
    SFT_CAPS,   _______,    _______,    _______,    _______,    _______,    _______,           _______,     TG(1),      MAKE,       KC_LBRC,    KC_RBRC,    TD(PIPE),   _______,   \
                                 _______,    _______,    _______,         _______,                 _______,         _______,    _______,    _______ \
),
 ...
 */
 ...
 [_FN] = LAYOUT( \
   ...
   * |           |           |           |           |           |           |                              |           |           |   Left    |   Down    |     Up    |   Right   |
   * |-----------+-----------+-----------+-----------+-----------+-----------|                              |-----------+-----------+-----------+-----------+-----------+-----------|
   * |   LWL0    |   GUI     |   Shift   |    Alt    |    Del    |           |-----------.      .-----------|           |           |   Home    |   Pg Dn   |   Pg Up   |    End    |
   * |-----------+-----------+-----------+-----------+-----------+-----------|           |      |           |-----------+-----------+-----------+-----------+-----------+-----------|
   * |           |           |           |           |           |           |-----------'      '-----------|  TG(LWR)  |   LWL0    |           |           |           |           |
   * '-----------------------------------------------------------------------'/-----------/    \-----------\.-----------------------------------------------------------------------'
   *                             |           |           |          |        /           /      \           \        |           |           |           |
   ...
   */
   ...
   [_LWL0] = LAYOUT( \
      ...
      _______,    KC_LGUI,    KC_LSFT,    KC_LALT,    KC_DEL,     _______,                                    _______,    _______,    KC_HOME,    KC_PGDN,    KC_PGUP,    KC_END,   \
      _______,    _______,    _______,    _______,    _______,    _______,    _______,           _______,     TG(1),      _______,    _______,    _______,    _______,    _______,  \
                                   _______,    _______,    _______,         _______,                 _______,           _______,    _______,    _______    \
    ),
  ...
  switch (keycode) {
    case MAKE:
      if (record->event.pressed) {  // when keycode is pressed
        SEND_STRING("make lily58:macos:avrdude");
